...
# Load Dataset
    ...
    id_model =  keras.models.load_model('./data/VGG16_id.h5')
    gender_model =  keras.models.load_model('./data/VGG16_gender.h5')
    lr_model =  keras.models.load_model('./data/VGG16_lr.h5')
    finger_model =  keras.models.load_model('./data/VGG16_finger.h5')
    ...
    features = VGG16_model.predict(input, verbose=0)
    ...
    Q1=[id_pred[0][id_prob_list[-1]], gender_pred[0][gender_prob_list[-1]], lr_pred[0][lr_prob_list[-1]], finger_pred[0][finger_prob_list[-1]]] #符合機率
    P1="" #符合圖片名
